...
<div class="main">
	<form class="form-horizontal form" action="index.php?r=reply/addvoices_do" method="post" enctype="multipart/form-data">
		...
		<table class="insert-tab">
			<tr>
				...
				<td>
					<input type="text" id="rule-name" class="common-text required" placeholder="" name="v_name" value="" /> &nbsp;
			...
			<tr>
				...
				<td>
					<input type="text" class="common-text required" placeholder="" name="v_keywords" value="" /> &nbsp;
					<span class="help-block">当用户的对话内容符合以上的关键字定义时，会触发这个回复定义。多个关键字请使用逗号隔开。</span>
				</td>
			</tr>
			<tr id="huifu">
				<th><label for="">上传语音文件</label></th>
				<td>
                    <input type="file" class="common-text required" placeholder="支持MP3格式" name="v_file" value=""/> &nbsp;
				</td>
			</tr>
			<tr id="huifu">
				<th><label for="">语音描述</label></th>
				<td>
                    <input type="text" class="common-text required" placeholder="" name="v_content" value="" /> &nbsp;
				</td>
			</tr>
			<tr>
				<th></th>
