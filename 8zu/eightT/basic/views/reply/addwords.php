...
<div class="main" >
	<form class="form-horizontal form" action="index.php?r=reply/addwords_do" method="post" >
		<h2>添加规则 <small>删除，修改规则、关键字以及回复后，请提交规则以保存操作。</small></h2>
		<?php 
		...
		<table class="insert-tab">
			<tr>
				...
				<td>
					<input type="text" id="rule-name" class="common-text required" placeholder="" name="w_name" value="" /> &nbsp;
			...
			<tr>
				...
				<td>
					<input type="text" class="common-text required" placeholder="" name="w_keywords" value="" /> &nbsp;
			...
			<tr id="huifu">
				...
				<td>
                    <input type="text" class="common-text required" placeholder="" name="w_content" value="" /> &nbsp;
				</td>
			</tr>
			<tr>
				<th></th>
