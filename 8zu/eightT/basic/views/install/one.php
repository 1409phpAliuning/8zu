	...
	<body style="background-color:#28b0e4;">
		<div class="container">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2014，EightT团队保留所有权利。 </h3>
				<p>
					感谢您选择EightT - 微信公众平台自助开源引擎（以下简称WE7，WE7基于 PHP + MySQL的技术开发，全部源码开放。 <br>
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于EightT系统(We7, MicroEngine. 以下简称EightT)任何版本，EightT官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
					<strong>二、协议许可的权利 </strong>
					</p><ol>
						<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
						<li>您可以在协议规定的约束和限制范围内修改EightT源代码或界面风格以适应您的网站要求。</li>
				...
				<p>
					<strong>三、协议规定的约束和限制 </strong>
						...
						<li>未经官方许可，禁止在EightT的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
		...
		<form class="form-inline" role="form" action="index.php?r=install/two" method="post">
			<ul class="pager">
				<li class="pull-left" style="display:block;padding:5px 10px 5px 0;">
					<div class="checkbox">
						<label>
                                                    <input type="checkbox" name="read" value="1"> 我已经阅读并同意此协议
						</label>
					</div>
				</li>
